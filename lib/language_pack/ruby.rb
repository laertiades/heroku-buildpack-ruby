...
private
  ...
  def setup_profiled
    instrument 'setup_profiled' do
      ...
      set_env_override "PATH",     "$HOME/#{slug_vendor_directory}/ffmpeg/bin:$PATH"
      set_env_override "LD_LIBRARY_PATH", "$HOME/#{slug_vendor_directory}/ffmpeg/lib:$LD_LIBRARY_PATH"
